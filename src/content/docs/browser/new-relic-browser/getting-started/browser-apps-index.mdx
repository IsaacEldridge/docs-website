...
To get started with this small edit I'm making on behalf of Michelle, who is the best, go to [Browser monitoring](/docs/browser/new-relic-browser/getting-started/introduction-new-relic-browser), go to [one.newrelic.com](http://one.newrelic.com) and select Browser at the top of the page. If you have already added apps, the Browser applications index automatically appears.
